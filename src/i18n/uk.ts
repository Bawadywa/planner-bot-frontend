...
export const uk: Record<Key, Phrase> = {
  ...
  "invite.boardCount": {
    one: "{count} дошка — її назва стане видимою після приєднання.",
    few: "{count} дошки — їхні назви стануть видимими після приєднання.",
    many: "{count} дошок — їхні назви стануть видимими після приєднання.",
    other: "{count} дошок — їхні назви стануть видимими після приєднання.",
  },
  "invite.noPreview":
    "Не показано — сервер позначає дошки номерами, а їхні назви видно лише учасникам. Приєднання робить їх видимими.",
  "invite.alreadyUsed": "Це посилання вже використано.",
  "invite.expiresAt": "Посилання дійсне до {when}.",
  "invite.expired":
    "Термін дії посилання сплив {when}. Попросіть нове в того, хто його надіслав.",
