...
export const uk: Record<Key, Phrase> = {
  ...
  "settings.inviteHint": "Спершу створіть дошку.",
  ...
  "settings.storedHereApi": "Залишки локального режиму та вибір мови.",
  ...
  "invite.unknownHandoff": "Токен {token} отримано.",
  "invite.unknownServed": "Це посилання більше не дійсне.",
  ...
  "invite.noPreview": "Буде видно після приєднання.",
  "invite.alreadyUsed": "Це посилання вже використано.",
  "invite.expiresAt": "Дійсне до {when}.",
  "invite.expired": "Термін минув {when}.",
  ...
  "missing.comments": "Потрібні id, user_id і created_at у CommentRead.",
  "missing.workspace": "Потрібен маршрут зі списком учасників простору.",
